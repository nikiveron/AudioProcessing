...
from app.models.strategies.config import SAMPLE_RATE, MODEL_CONFIG, CHUNK_SIZE, OVERLAP_RATIO, DEVICE, KEYS_MODEL_PATH


class KeysProcessingStrategy(BaseProcessingStrategy):

    def __init__(self):
        super().__init__(
            model_path=str(KEYS_MODEL_PATH),
